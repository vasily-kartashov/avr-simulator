int at90s8535_int[]={
  RESET,INT0,INT1,TIMER2_COMP,TIMER2_OVF,TIMER1_CAPT,TIMER1_COMPA,TIMER1_COMPB,
  TIMER1_OVF,TIMER0_OVF,SPI_STC,UART0_RX,UART0_UDRE,UART0_TX,ADC,EE_READY,
  ANALOG_COMP,-1};

IO_port at90s8535_io[]={
  {SREG,  0x3F,0xFF,0xFF,0},
  {SPH,   0x3E,0x03,0x03,0},
