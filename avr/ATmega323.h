int atmega323_int[]={
  ...
  TIMER1_COMPB,TIMER1_OVF,TIMER0_COMP,TIMER0_OVF,SPI_STC,UART0_RX,
  UART0_UDRE,UART0_TX,ADC,EE_READY,ANALOG_COMP,TWSI,-1};

IO_port atmega323_io[]={
  {SREG,  0x3F,0xFF,0xFF,0},
  {SPH,   0x3E,0x0F,0x0F,0},
