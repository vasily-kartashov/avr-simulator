...
IO_port atmega8_io[]={
  ...
  {PORTC, 0x15,0x7F,0x7F,0},
  {DDRC,  0x14,0x7F,0x7F,0},
  ...
  {ACSR,  0x08,0xDF,0xDF,0},
  {ADMUX, 0x07,0xEF,0xEF,0},
...
Pin atmega8_pins[]={
  {IC1_PIN,  0x18,0x16,1<<0},
  {OC1A_PIN, 0x18,0x16,1<<1},
  {OC1B_PIN, 0x18,0x16,1<<2},{SS_PIN,  0x18,0x16,1<<2},
  {OC2_PIN,  0x18,0x16,1<<3},{MOSI_PIN,0x18,0x16,1<<3},
  {MISO_PIN, 0x18,0x16,1<<4},
  {SCK_PIN,  0x18,0x16,1<<5},
  {TOSC1_PIN,0x18,0x16,1<<6},
  {TOSC2_PIN,0x18,0x16,1<<7},
  ...
  {AIN0_PIN, 0x12,0x10,1<<6},
  {AIN1_PIN, 0x12,0x10,1<<7},

  {ADC0_PIN, 0x15,0x13,1<<0},
  {ADC1_PIN, 0x15,0x13,1<<1},
  {ADC2_PIN, 0x15,0x13,1<<2},
  {ADC3_PIN, 0x15,0x13,1<<3},
  {ADC4_PIN, 0x15,0x13,1<<4},{SDA_PIN,0x15,0x13,1<<4},
  {ADC5_PIN, 0x15,0x13,1<<5},{SCL_PIN,0x15,0x13,1<<5},
  {-1,0,0,0}
};
